...
import { isDraw, calculateWinner, getPlayerNameFromSign } from "../gameUtils";
...
describe("Tests", () => {
  ...
  it("should return winner X if X wins", () => {
    const squares = [Sign.X, Sign.X, Sign.X, Sign.O, Sign.O, Sign.O, Sign.O, Sign.O, Sign.O];
    expect(calculateWinner(squares)).toBe(Sign.X);
  });

  // should return winner O if O wins
  it("should return winner O if O wins", () => {
    const squares = [Sign.X, Sign.X, Sign.O, Sign.O, Sign.O, Sign.O, Sign.O, Sign.O, Sign.O];
    expect(calculateWinner(squares)).toBe(Sign.O);
  });

  // should return draw if no winner
  it("should return draw if no winner", () => {
    const squares = [Sign.X, Sign.O, Sign.X, Sign.O, Sign.O, Sign.X, Sign.X, Sign.X, Sign.O];
  ...
  it("should return true if all squares are filled", () => {
    const squares = [Sign.X, Sign.O, Sign.X, Sign.O, Sign.X, Sign.O, Sign.X, Sign.O, Sign.O];
  ...
  it("should return null when game is still in progress", () => {
    const squares = [Sign.X, Sign.O, Sign.X, Sign.O, null, null, null, null, null];
  ...
  it("should detect diagonal win for X", () => {
    const squares = [Sign.X, Sign.O, Sign.O, null, Sign.X, Sign.O, null, null, Sign.X];
    expect(calculateWinner(squares)).toBe(Sign.X);
  });
